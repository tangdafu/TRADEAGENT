...
- ✅ **资金费率** - Binance公开API
- ✅ **K线数据** - Binance公开API
- ✅ **市场压力** - Binance公开API（持仓量、多空比、买卖量）

### 可选数据（需要API密钥）
- 🔑 **新闻情绪** - 需要 CryptoCompare API Key + NewsAPI Key

> 💡 提示：
> - **市场压力数据**已替代原爆仓数据API（Binance爆仓API已停止维护）
> - 使用持仓量、多空比、主动买卖量等指标来评估市场压力和爆仓风险
> - 即使不配置新闻API，系统仍可正常运行，只是缺少消息面维度
